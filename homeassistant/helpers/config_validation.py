...
country = vol.In(
    # The list of ISO 3166 alpha-2 country codes is generated by:
    # import pycountry
    # sorted(set(x.alpha_2 for x in pycountry.countries))
    # The values are directly corresponding to the ISO standard. If you need changes to
    # the political situation in the world, please talk to the ISO working group.
    # Generated from pycountry=22.3.5
    {
        "AD",
        "AE",
        "AF",
    ...
    msg="invalid ISO 3166 formatted country",
)
